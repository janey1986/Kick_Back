<?php
/**
 * Template Name: template - full sidebar
 *
 * @package WordPress
			...
			<div id="rightCol" class="rightCol hidden-xs col-sm-4 col-md-4 well">
				<div id="sidebarContentContainer">
					<div id="rightColTitleDiv"><h1>Join Mailing List</h1></div>
						...
						<div class="clear"></div>
						<br/>
				<div id="rightColTitleDiv"><h1>Buy Tickets</h1></div>
					<div style='padding-bottom: 10px;'>
						<a href='<?php echo $sidebarBuyTicketsLink1;?>' ><img id="sidebarBuyTickets" src='<?php echo $sidebarBuyTicketsImage1; ?>' /></a>
					</div>
					<div style='padding-bottom: 10px;'>
					 	<a href='<?php echo $sidebarBuyTicketsLink2; ?>' ><img id="sidebarBuyTickets" src='<?php echo $sidebarBuyTicketsImage2; ?>' /></a>
					</div>
					<div class="clear"></div>
					<br/>
